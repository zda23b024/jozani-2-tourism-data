...
REVIEW_CATEGORY_SCORE_COLUMNS = [
    "id",
    "review_category_score_id",
    "review_id",
    "category_name",
    "score",
    "rating_scale",
...
TABLE_COLUMNS = {
    ...
    "restaurants": RESTAURANT_COLUMNS,
    "operating_hours": OPERATING_HOUR_COLUMNS,
    ...
    "review_category_scores": REVIEW_CATEGORY_SCORE_COLUMNS,
...
TABLE_CONFLICT_COLUMNS = {
    ...
    "operating_hours": ["place_source_id", "day_of_week"],
    ...
    "review_category_scores": ["review_id", "category_name"],
